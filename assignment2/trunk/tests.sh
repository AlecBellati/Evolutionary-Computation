...
for i in {1..5}
do
time java Driver -f ../instances/a280_n279_bounded-strongly-corr_01.ttp >> a280_n279_bounded-strongly-corr_01.txt
done

echo 'a280_n1395_uncorr-similar-weights_05.ttp'
for i in {1..5}
do
time java Driver -f ../instances/a280_n1395_uncorr-similar-weights_05.ttp >> a280_n1395_uncorr-similar-weights_05.txt
done

echo 'a280_n2790_uncorr_10.ttp'
for i in {1..5}
do
time java Driver -f ../instances/a280_n2790_uncorr_10.ttp >> a280_n2790_uncorr_10.txt
done
